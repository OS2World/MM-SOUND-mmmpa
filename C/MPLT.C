...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MPLT
#define  NAME_DEF                   NAME_MPLT
#define  NAMEJ_DEF                  NAMEJ_MPLT
#define  EXT_DEF                    EXT_MPLT
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MPLT

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MPLT(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
...
PMMFORMATINFO     pMMFmtInfo;
   ...
   case MMIOM_OPEN:
      if(!pMMInfo)   break;
      pMMInfo->pExtraInfoStruct=(PVOID)(MPA_EFLAG_LAY_2|MPA_EFLAG_DOUBLIZECOMP|MPA_EFLAG_BITRATE_LAY2_32KBPS);
