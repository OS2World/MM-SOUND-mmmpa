...
/* ENCODE: LAYER-2 128kbps (STANDARD COMPRESSION)                       */
/*                                                                      */
/*                                                        Version 1.0.0 */
...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MP2C
#define  NAME_DEF                   NAME_MP2C
#define  NAMEJ_DEF                  NAMEJ_MP2C
#define  EXT_DEF                    EXT_MP2C
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MP2C

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MP2C(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
...
MPAOPTIONS        MpaOpt;
   ...
   case MMIOM_OPEN:
      ...
      MpaOpt.ulFlags=MPA_EFLAG_LAY_2|MPA_EFLAG_BITRATE_LAY2_128KBPS;
