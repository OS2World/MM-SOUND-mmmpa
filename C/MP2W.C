...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MP2W
#define  NAME_DEF                   NAME_MP2W
#define  NAMEJ_DEF                  NAMEJ_MP2W
#define  EXT_DEF                    EXT_MP2W
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MP2W

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MP2W(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
...
MPAOPTIONS        MpaOpt;
   ...
   case MMIOM_OPEN:
      ...
      MpaOpt.ulFlags=MPA_EFLAG_LAY_2|MPA_EFLAG_SPS_48KHZ;
