...
/* ENCODE: LAYER-2 32kbps (TELEPHONE LINE)                              */
/*                                                                      */
/*                                                        Version 1.0.0 */
...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MP2T
#define  NAME_DEF                   NAME_MP2T
#define  NAMEJ_DEF                  NAMEJ_MP2T
#define  EXT_DEF                    EXT_MP2T
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MP2T

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MP2T(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
...
MPAOPTIONS        MpaOpt;
   ...
   case MMIOM_OPEN:
      ...
      MpaOpt.ulFlags=MPA_EFLAG_LAY_2|MPA_EFLAG_BITRATE_LAY2_32KBPS;
