...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MPW1
#define  NAME_DEF                   NAME_MPW1
#define  NAMEJ_DEF                  NAMEJ_MPW1
#define  EXT_DEF                    EXT_MPW1
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MPW1

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MPW1(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
