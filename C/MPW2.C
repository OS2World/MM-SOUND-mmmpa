...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MPW2
#define  NAME_DEF                   NAME_MPW2
#define  NAMEJ_DEF                  NAMEJ_MPW2
#define  EXT_DEF                    EXT_MPW2
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MPW2

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MPW2(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
