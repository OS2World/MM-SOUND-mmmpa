...
/* ENCODE: LAYER-2 L2 COMP - 192kbps (HQ)                               */
/*                                                                      */
/*                                                        Version 1.0.0 */
...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MPLS
#define  NAME_DEF                   NAME_MPLS
#define  NAMEJ_DEF                  NAMEJ_MPLS
#define  EXT_DEF                    EXT_MPLS
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MPLS

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MPLS(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
...
PMMFORMATINFO     pMMFmtInfo;
   ...
   case MMIOM_OPEN:
      if(!pMMInfo)   break;
      pMMInfo->pExtraInfoStruct=(PVOID)(MPA_EFLAG_LAY_2|MPA_EFLAG_DOUBLIZECOMP|MPA_EFLAG_BITRATE_LAY2_384KBPS);
