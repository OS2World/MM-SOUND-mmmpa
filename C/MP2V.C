...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MP2V
#define  NAME_DEF                   NAME_MP2V
#define  NAMEJ_DEF                  NAMEJ_MP2V
#define  EXT_DEF                    EXT_MP2V
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MP2V

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MP2V(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
...
MPAOPTIONS        MpaOpt;
   ...
   case MMIOM_OPEN:
      ...
      MpaOpt.ulFlags=MPA_EFLAG_LAY_2|MPA_EFLAG_SPS_44KHZ;
