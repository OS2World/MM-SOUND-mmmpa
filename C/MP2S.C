...
#define  FOURCC_MMIOPROC_DEF        FOURCC_MMIOPROC_MP2S
#define  NAME_DEF                   NAME_MP2S
#define  NAMEJ_DEF                  NAMEJ_MP2S
#define  EXT_DEF                    EXT_MP2S
#define  SUPPORTFLAG_DEF            SUPPORTFLAG_MP2S

/* ******************************************************************** */
/* メイン関数                                                           */
/* ******************************************************************** */
LONG EXPENTRY _export MMIOENTRY_MP2S(PVOID pVoid,USHORT usMsg,LONG mp1,LONG mp2)  {
LONG              lRC=MMIO_ERROR;
...
MPAOPTIONS        MpaOpt;
   ...
   case MMIOM_OPEN:
      ...
      MpaOpt.ulFlags=MPA_EFLAG_LAY_2|MPA_EFLAG_BITRATE_LAY2_384KBPS;
